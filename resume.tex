...
\\
Using HTML, CSS, and JavaScript, created basic websites and completed various challenges ranging from
building a dice game to an online diary app, supported by \textit{Scrimba's Front-End Developer Career Path}. \\
\vspace*{2mm}
