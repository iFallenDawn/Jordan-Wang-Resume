...
%==== Skills ====%
\header{Skills}
	Java, JavaScript, Selenium, Python, C++, Git, HTML, CSS, \LaTeX, OCaml, Adobe Photoshop, Adobe Premiere, Microsoft Azure                    \\
\vspace{2mm}
...
{\textbf{CINTAS Nickname Matching (2021)}} \hfill 
\\
Using Python, created a script to sift through data for potential nicknames of employees and their employment statuses, cancelling uniform orders and eliminating discrepancies within the data to save Con Edison thousands of dollars from inactive employees.\\
\vspace*{2mm}

{\textbf{Registered Tags Web Scraper (2021)}} \hfill 
\\
Using Python, created and distributed a web scraping script within Con Edison to pull and migrate data to a JSON file, replacing a repetitive task and reducing the chance for human error when connecting with Tableau.\\
\vspace*{2mm}
...
\textbf{Con Edison Electric Operations Business Cost Optimization (BCO)} \hfill New York, NY\\
